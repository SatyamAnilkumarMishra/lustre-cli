"""Module 4 — Lustre validation tests with logging."""
...
def cmd_basic() -> None:
    ...
    log.info("PASS: created %s, wrote and verified %s", test_dir, test_file)
...
def cmd_stripe() -> None:
    ...
    log.info("PASS: striping configured (stripe_count=%d)", stripe_cnt)
...
def cmd_integrity() -> None:
    ...
    log.info("PASS: SHA256 integrity verified (%d bytes)", len(data))
